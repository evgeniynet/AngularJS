...
var AddFilesModal = (function () {
    function AddFilesModal(nav, navParams, dataProvider, config, viewCtrl) {
        this.nav = nav;
    ...
    AddFilesModal.prototype.ngOnInit = function () {
        this.ispassword = true;
        this.data = (this.navParams.data || {}).type || {};
        this.firstname_m = (this.navParams.data || {}).name || " ";
    };
    AddFilesModal.prototype.ngAfterViewInit = function () {
    ...
    AddFilesModal.prototype.dismissPage = function (data) {
        this.viewCtrl.dismiss(data);
    };
    AddFilesModal.prototype.onSubmit = function (form) {
        var _this = this;
        if (form.valid) {
    ...
    return AddFilesModal;
}());
exports.AddFilesModal = AddFilesModal;
